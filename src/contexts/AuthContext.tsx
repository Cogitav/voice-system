...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  // Fetch user role from backend RPC - SINGLE SOURCE OF TRUTH
  const fetchUserRole = async (): Promise<AppRole | null> => {
    try {
  ...
  // Fetch user profile (without role - role comes from RPC)
